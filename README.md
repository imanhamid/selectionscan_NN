...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td rowspan=1 align="center">mu</td>
            <td rowspan=1 align="center">mean selection coefficient for gamma distributed fitness effects</td>
            <td rowspan=1 align="center">-d mu=-0.01314833</td>
        </tr>
        <tr>
            <td rowspan=1 align="center">alpha</td>
            <td rowspan=1 align="center">alpha shape parameter for gamma distributed fitness effects</td>
            <td rowspan=1 align="center">-d alpha=0.186</td>
        </tr>
        <tr>
